...
|----------|----------|-------------|
| `PIHOLE_API_KEY` | No | API key for Pi-hole integration. Get it from your Pi-hole admin panel at `http://<pi-hole-ip>:8080/admin/settings.php?tab=api` (v5 only; v6+ uses different authentication) |
